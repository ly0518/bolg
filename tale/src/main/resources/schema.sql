...
INSERT INTO `tale`.`t_comments` ( `cid`, `created`, `author`, `author_id`, `owner_id`, `mail`, `url`, `ip`, `agent`, `content`, `type`, `status`, `parent`)
VALUES ( '5', '1471363200', '乘风破浪', '0', '1', '12333@qq.com', NULL, '127.0.0.1', NULL, 'idea安装了插件一直报错', 'comment', 'approved', '0');
